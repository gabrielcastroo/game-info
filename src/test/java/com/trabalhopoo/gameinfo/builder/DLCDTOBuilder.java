...
@Builder
public class DLCDTOBuilder {

    @Builder.Default
    private final Long id = 1L;
    @Builder.Default
    private final String name = "DLC Teste";
    @Builder.Default
    ...
    @Builder.Default
    private final String description = "Descrição da DLC Teste";
    @Builder.Default
    ...
    public DLCDTO buildDlcDTO(){
        return new DLCDTO(id,name,urlImage,releaseDate,
